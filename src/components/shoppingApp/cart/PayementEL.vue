...
<template>
  <div class="p-6">
    ...
    <div class="flex justify-between font-bold mb-1 text-xl">
      ...
      <span>{{ itemsStore.total }}€</span>
    </div>
    <my-button @click="itemsStore.resetCart">Procéder au paiement</my-button>
  </div>
</template>
